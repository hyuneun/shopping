		...
		<form name="updateForm" method="post" action="memberUpdateproc.jsp">
			<table border="1">
				<tr align="center" style="background-color: #8899aa">
					<td colspan="2"><b style="color: #FFFFFF"><%=bean.getId() %>님의 회원 수정</b></td>
				</tr>
				<tr>
					<td width="16%">아이디</td>
					<td width="57%"><%=bean.getId() %></td>
					<td><input type="hidden" name="id" size="15" value="<%=bean.getId()%>"></td>
				</tr>
				<tr>
					<td>패스워드</td>
					<td><input type="password" name="passed" size="15" value="<%=bean.getPassed()%>"></td>
				</tr>
				<tr>
					<td>이름</td>
